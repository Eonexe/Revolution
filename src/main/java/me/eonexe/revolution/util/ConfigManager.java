package me.eonexe.revolution.util;
...
import me.eonexe.revolution.friends.Friend;
import me.eonexe.revolution.friends.Friends;

import static me.eonexe.revolution.BadlionMod.moduleManager;
...
public class ConfigManager {
    ...
    public ConfigManager() {
        this.BadlionPlus = new File("Revolution");
        if (!this.BadlionPlus.exists()) {
            this.BadlionPlus.mkdirs();
        }

        this.Settings = new File("Revolution" + File.separator + "Settings");
