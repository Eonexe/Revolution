package me.eonexe.revolution.clickgui.component.components.sub;
...
import me.eonexe.revolution.clickgui.component.Component;
import me.eonexe.revolution.clickgui.component.components.Button;
...
public class Slider extends Component {
	...
	public void renderComponent() {
		Gui.drawRect(parent.parent.getX() + 2, parent.parent.getY() + offset, parent.parent.getX() + parent.parent.getWidth(), parent.parent.getY() + offset + 12, this.hovered ? 0xFF434343 : 0xFF313131);
		 final int drag = (int)(this.set.getValDouble() / this.set.getMax() * this.parent.parent.getWidth());
		Gui.drawRect(parent.parent.getX() + 2, parent.parent.getY() + offset, parent.parent.getX() + (int) renderWidth, parent.parent.getY() + offset + 12,hovered ? new Color(61,110,190).getRGB() : new Color(61,110,160).getRGB());
		...
		BadlionMod.fontRenderer.drawStringWithShadow(this.set.getDisplayName() + ": " + this.set.getValDouble() , (parent.parent.getX()* 2 + 15), (parent.parent.getY() + offset + 2) * 2 + 5, -1);
	...
	public void mouseReleased(int mouseX, int mouseY, int mouseButton) {
		dragging = false; BadlionMod.configManager.SaveAll();
	}
