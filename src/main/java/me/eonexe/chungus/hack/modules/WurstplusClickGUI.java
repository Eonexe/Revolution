package me.eonexe.chungus.hack.modules;
...
public class WurstplusClickGUI extends WurstplusHack {
	...
	public WurstplusClickGUI() {
		...
		set_bind(Chungus.WURSTPLUS_KEY_GUI);
	}

	WurstplusSetting label_frame = create("info", "ClickGUIInfoFrame", "Frames");

	WurstplusSetting name_frame_r = create("Name R", "ClickGUINameFrameR", 0, 0, 255);
	...
	WurstplusSetting background_frame_b = create("Background B", "ClickGUIBackgroundFrameB", 64, 0, 255);
	...
	WurstplusSetting name_widget_r = create("Name R", "ClickGUINameWidgetR", 0, 0, 255);
	...
	public void update() {
		// Update frame colors.
		Chungus.click_gui.theme_frame_name_r = name_frame_r.get_value(1);
		Chungus.click_gui.theme_frame_name_g = name_frame_g.get_value(1);
		Chungus.click_gui.theme_frame_name_b = name_frame_b.get_value(1);

		Chungus.click_gui.theme_frame_background_r = background_frame_r.get_value(1);
		Chungus.click_gui.theme_frame_background_g = background_frame_g.get_value(1);
		Chungus.click_gui.theme_frame_background_b = background_frame_b.get_value(1);
		Chungus.click_gui.theme_frame_background_a = background_frame_a.get_value(1);

		Chungus.click_gui.theme_frame_border_r = border_frame_r.get_value(1);
		Chungus.click_gui.theme_frame_border_g = border_frame_g.get_value(1);
		Chungus.click_gui.theme_frame_border_b = border_frame_b.get_value(1);

		// Update widget colors.
		Chungus.click_gui.theme_widget_name_r = name_widget_r.get_value(1);
		Chungus.click_gui.theme_widget_name_g = name_widget_g.get_value(1);
		Chungus.click_gui.theme_widget_name_b = name_widget_b.get_value(1);

		Chungus.click_gui.theme_widget_background_r = background_widget_r.get_value(1);
		Chungus.click_gui.theme_widget_background_g = background_widget_g.get_value(1);
		Chungus.click_gui.theme_widget_background_b = background_widget_b.get_value(1);
		Chungus.click_gui.theme_widget_background_a = background_widget_a.get_value(1);

		Chungus.click_gui.theme_widget_border_r = border_widget_r.get_value(1);
		Chungus.click_gui.theme_widget_border_g = border_widget_g.get_value(1);
		Chungus.click_gui.theme_widget_border_b = border_widget_b.get_value(1);
	}

	@Override
	public void enable() {
		if (mc.world != null && mc.player != null) {
			mc.displayGuiScreen(Chungus.click_gui);
		}
	}
