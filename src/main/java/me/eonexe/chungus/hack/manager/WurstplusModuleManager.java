...
import me.eonexe.chungus.hack.modules.*;
import me.eonexe.chungus.hack.modules.chat.*;
import me.eonexe.chungus.hack.modules.combat.*;
import me.eonexe.chungus.hack.modules.dev.*;
import me.eonexe.chungus.hack.modules.exploit.*;
import me.eonexe.chungus.hack.modules.misc.*;
import me.eonexe.chungus.hack.modules.movement.*;
import me.eonexe.chungus.hack.modules.render.*;
...
public class WurstplusModuleManager {
	...
	public WurstplusModuleManager() {
		...
		add_hack(new Burrow());
		add_hack(new AutoTNTCart());
		add_hack(new Chungus());
		add_hack(new WurstplusElytraFly());
