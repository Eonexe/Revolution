package me.eonexe.chungus.hack.guiscreen.render.components.widgets;


import me.eonexe.chungus.Chungus;
import me.eonexe.chungus.hack.guiscreen.render.WurstplusDraw;
import me.eonexe.chungus.hack.guiscreen.render.components.WurstplusAbstractWidget;
import me.eonexe.chungus.hack.guiscreen.render.components.WurstplusFrame;
import me.eonexe.chungus.hack.guiscreen.render.components.WurstplusModuleButton;
import me.eonexe.chungus.hack.guiscreen.settings.WurstplusSetting;
import me.eonexe.turok.values.TurokDouble;
...
public class WurstplusSlider extends WurstplusAbstractWidget {
	...
	public WurstplusSlider(WurstplusFrame frame, WurstplusModuleButton master, String tag, int update_postion) {
		this.frame   = frame;
		this.master  = master;
		this.setting = Chungus.get_setting_manager().get_setting_with_tag(master.get_module(), tag);
	...
	public void render(int master_y, int separe, int absolute_x, int absolute_y) {
		...
		int ns_r = Chungus.click_gui.theme_widget_name_r;
		int ns_g = Chungus.click_gui.theme_widget_name_g;
		int ns_b = Chungus.click_gui.theme_widget_name_b;
		int ns_a = Chungus.click_gui.theme_widget_name_b;

		int bg_r = Chungus.click_gui.theme_widget_background_r;
		int bg_g = Chungus.click_gui.theme_widget_background_g;
		int bg_b = Chungus.click_gui.theme_widget_background_b;
		int bg_a = Chungus.click_gui.theme_widget_background_a;

		int bd_r = Chungus.click_gui.theme_widget_border_r;
		int bd_g = Chungus.click_gui.theme_widget_border_g;
		int bd_b = Chungus.click_gui.theme_widget_border_b;
		int bd_a = 100;
