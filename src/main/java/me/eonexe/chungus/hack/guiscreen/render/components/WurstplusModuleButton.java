...
import me.eonexe.chungus.hack.guiscreen.render.components.widgets.*;
...
public class WurstplusModuleButton {
	...
	public WurstplusModuleButton(WurstplusHack module, WurstplusFrame master) {
		...
		for (WurstplusSetting settings : Chungus.get_setting_manager().get_settings_with_hack(module)) {
		...
		int size = Chungus.get_setting_manager().get_settings_with_hack(module).size();
	...
	public void render(int mx, int my, int separe) {
		...
		int nm_r = Chungus.click_gui.theme_widget_name_r;
		int nm_g = Chungus.click_gui.theme_widget_name_g;
		int nm_b = Chungus.click_gui.theme_widget_name_b;
		int nm_a = Chungus.click_gui.theme_widget_name_a;
