...
public class WurstplusMessageUtil {
	...
	public static String opener = g + Chungus.WURSTPLUS_NAME + ChatFormatting.GRAY + " > " + r;
	...
	public static void send_client_message_simple(String message) {
		client_message(ChatFormatting.GOLD + Chungus.WURSTPLUS_NAME + " " + r + message);
	}
	...
	public static void send_client_error_message(String message) {
		client_message(ChatFormatting.RED + Chungus.WURSTPLUS_NAME + " " + r + message);
	}
